...
//
//  private static ScreenshotImpl2 sInstance;
...
//   * instrumentation
//   */
//  private static ScreenshotImpl2 create(Context context) {
//    Album album = AlbumImpl.create(context, "default");
//    album.cleanup();
//    return new ScreenshotImpl2(album);
//  }
//
//  /** Get a singleton instance of the ScreenshotImpl */
//  public static ScreenshotImpl2 getInstance() {
//    if (sInstance != null) {
//      return sInstance;
//    }
//
//    synchronized (ScreenshotImpl2.class) {
//      if (sInstance != null) {
//        return sInstance;
//      }
//
